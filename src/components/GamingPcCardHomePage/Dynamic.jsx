...
import "../GamingPcCardHomePage/Dynamic.css";
    ...
    <>
      <div>
        <div>
          ...
          <div className="backgroundTExt1">
            <div className="secondBlockText">
              <h2>Стильный и мощный</h2>
              <h3>Абсолютно новая формула дизайна</h3>
              <p>
                HYPERPC DYNAMIC — настоящее воплощение стиля. Про такой
                компьютер можно сказать только одно — «в нём нет ничего
                лишнего». Боковая и передняя прозрачные панели из закалённого
                стекла вместе со стильной RGB-подсветкой наглядно показывают
                продуманное расположение всех важных деталей. Особенно это
                касается водяной системы охлаждения и подсвечиваемых боковых
                вентиляторов. С таким ПК вам не страшны даже самые сложные
                испытания в любых современных и скоро выходящих играх.
              </p>
            </div>

            <img
              className="backImage"
              src="https://hyperpc.ru/images/product/dynamic/update_landing/main/hpc-dynamic-3in1-block.jpg"
              alt=""
            />
          </div>
          ...
          <div className="d-flexBlock">
            <div>
              <img
                className="lumenIMG3"
                src="https://hyperpc.ru/images/product/dynamic/update_landing/main/hpc-dynamic-rgb-descr_webp.jpg"
                alt="image"
              />
            </div>
            <div className="lumenTextBlock3">
              ...
              <div className="blocksImageLumen3">
                <img
                  src="https://hyperpc.ru/images/product/dynamic/update_landing/main/landing_gallery/standard-rgb/hyperpc-dynamic-black-rgb-gallery-thumb-01.jpg"
                  alt=""
                />
                <img
                  src="https://hyperpc.ru/images/product/dynamic/update_landing/main/landing_gallery/standard-rgb/hyperpc-dynamic-black-rgb-gallery-thumb-02.jpg"
                  alt=""
                />
                <img
                  src="https://hyperpc.ru/images/product/dynamic/update_landing/main/landing_gallery/standard-rgb/hyperpc-dynamic-black-rgb-gallery-thumb-03.jpg"
                  alt=""
                />
              </div>
              ...
              <div className="blocksImageLumen3">
                <img
                  src="https://hyperpc.ru/images/product/dynamic/update_landing/main/landing_gallery/standard-rgb/hyperpc-dynamic-white-rgb-gallery-thumb-01.jpg"
                  alt=""
                />
                <img
                  src="https://hyperpc.ru/images/product/dynamic/update_landing/main/landing_gallery/standard-rgb/hyperpc-dynamic-white-rgb-gallery-thumb-02.jpg"
                  alt=""
                />
                <img
                  src="https://hyperpc.ru/images/product/dynamic/update_landing/main/landing_gallery/standard-rgb/hyperpc-dynamic-white-rgb-gallery-thumb-03.jpg"
                  alt=""
                />
              </div>
            </div>
            ...
            <div className="blockWidth">
              <div className="BlockTextLumen3">
                ...
                <p>
                  ...
                  высочайшего качества. Поскольку мы в службе клиентской
                  поддержки также являемся геймерами, мы уверены, что наше
                  сообщество заслуживает клиентского обслуживания высочайшего
                  уровня.
                </p>
                ...
                <ul className="ulList">
                  ...
                  <li>
                    ...
                    <span>
                      Техническая консультация по телефону, в мессенджерах,
                      e-mail с возможностью удаленного подключения для решения
                      возникшей ситуации
                    </span>
                  </li>
                  <div className="divLine"></div>
